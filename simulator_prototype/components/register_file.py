...
class Register(Sequential):
    ...
    def __init__(self, name, clock, reset, regwr, wd3, a1, a2, a3, rd1, rd2, size, default_state = 0, edge_type = Register_Edge_Type.LATCH_RISING_EDGE, reset_type = Register_Reset_Type.RESET_ACTIVE_LOW):
