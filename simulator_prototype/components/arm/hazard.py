...
class hazardController():
    ...
    def __init__(self, ra1e, ra2e, ra3m, ra3w, regwrm, regwrw, regsrce, fwda,
                fwdb, stalld, flushd, flushe):
    ...
    @staticmethod
    def _generate_fwda(ra1e, ra3m, ra3w, regwrm, regwrw):
    ...
    @staticmethod
    def _generate_fwdb(ra2e, ra3m, ra3w, regwrm, regwrw):
    ...
    def run(self, time = None):
        ...
        self._stalld.write(self._generate_stalld())
